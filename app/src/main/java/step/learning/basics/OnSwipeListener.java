...
public class OnSwipeListener implements View.OnTouchListener {
    ...
    private final class GestureListener extends GestureDetector.SimpleOnGestureListener {
        private static final int MIN_SWIPE_DISTANCE = 100; // растояние между точками начала и конца свайпа
        private static final int MIN_SWIPE_VELOCITY = 100; // скорость свайпа
